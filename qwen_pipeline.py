...
5. 信息锚点：是否有能帮助未来回忆的具体细节，如人物、动作、物品、环境、文字
6. 稀缺性：这一瞬间是否不容易重复，是否有“值得记住”的独特性

评分规则：
- 0-3：普通记录，缺少可唤起回忆的明确内容
- 4-6：有一定家庭记录价值，但回忆点有限
- 7-8：回忆度较高，未来容易想起具体人和情境
- 9-10：强回忆照片，具有明显纪念意义或强烈情感价值
...
无论选择哪种 caption_style，都必须满足以下前提：
- 语言自然，不生硬，不像说明文
- 带一点诗意和画面感，但不要过度堆砌辞藻
- 不要写成 AI 总结口吻
- 不要使用“这张照片里……”“画面中……”“照片记录了……”这类说明式开头
- 更像人看到家庭相册时，顺手写下的一句题注
- 不要凭空推断成长阶段、人生节点或“第一次”类故事
- 除非图片里有非常明确的视觉证据，否则不要写“刚学会走路 / 刚学会游泳 / 第一次 / 那时候还小 / 小时候 / 初学 / 刚开始”这类表达
- 如果无法确认，就只写照片中可见的人物、动作、关系、场景、情绪与氛围，不要补背景故事
...
- memory_note：有回忆感，像多年后翻相册时心里冒出来的一句回想，不要写成事件说明
- life_sentence：偏日常、克制、自然
- documentary_line：像纪实题注，简洁克制，但仍要有一点温度
- poetic_line：略带诗意，但不要过度
- album_title：短标题感，适合相册分组或封面"""
